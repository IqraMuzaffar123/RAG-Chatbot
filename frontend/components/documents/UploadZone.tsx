    ...
    return (
      <>
        ...
        >
          ...
          />
          <Upload
            className="w-[42px] h-[42px] transition-colors duration-[180ms]"
            style={{ color: dragOver ? "#34d399" : "#475569" }}
          />
          <div className="text-[15px] font-semibold text-slate-200 mt-3.5">
            {dragOver ? "Drop to upload" : "Drag & drop files here"}
          </div>
          <div className="text-[12.5px] text-slate-400 mt-[5px]">
            or{" "}
            <span className="text-teal-300 font-medium">click to browse</span>
          </div>
          <div className="font-mono text-[11px] text-slate-500 mt-3.5">
        ...
        {error && (
          <div
            className="mt-3 flex items-center gap-2 rounded-xl px-3 py-2 text-xs text-red-400"
      ...
      <>
        ...
        <div className="mt-4 space-y-2">
          ...
          <button
            ...
            className="mt-2 w-full flex items-center justify-center gap-1.5 font-semibold text-[13px] py-[11px] rounded-xl cursor-pointer transition-colors"
            style={{
        ...
        {files.map((file, i) => (
          <div key={`${file.name}-${i}`}>
            <div className="flex items-center justify-between mb-[7px]">
              ...
              <span className="font-mono text-[11.5px] text-teal-300">
                {(file.size / 1024).toFixed(1)} KB
              </span>
            </div>
            <div
  ...
  if (state === "done" && result) {
    return (
      ...
      >
        ...
        <button
          onClick={reset}
          className="text-[12.5px] font-semibold cursor-pointer transition-colors"
          style={{
            color: "#5eead4",
  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="mt-3 text-[12.5px] font-semibold cursor-pointer"
        style={{
          color: "#5eead4",
          background: "rgba(16,185,129,0.12)",
          border: "1px solid rgba(16,185,129,0.25)",
